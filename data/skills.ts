...
export const skillsByCategory: Record<SkillCategory, RawSkillInput[]> = {
  ...
  "Tools & Technologies": [
    "Next.js",
    { name: "Design Systems", label: "Systems" },
    "Performance",
    "Tailwind",
    { name: "API Design", label: "APIs" },
    "Shadcn",
  ],
  "App Development": [
    "React",
    { name: "Accessibility", label: "A11y" },
    "Motion",
    { name: "Creative Coding", label: "Creative" },
    { name: "Animation", label: "Animate" },
    { name: "Interaction Design", label: "UX Flow" },
    { name: "Visual Design", label: "Visual" },
    { name: "Rapid Prototyping", label: "Prototype" },
  ],
  "AI/ML & Data Science": [
    { name: "AI Prototyping", label: "AI UX" },
    "Research",
    "Machine Learning",
    "Data Science",
  ],
  Leadership: [
    "Branding",
    { name: "Product Thinking", label: "Product" },
    { name: "Communication", label: "Comms" },
    "Teamwork",
  ],
};
